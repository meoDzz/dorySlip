                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse; margin-bottom: 25px;">
                                    <thead style="background-color: #f2f7fc; font-weight: 600; color: #333;">
                                        <tr>
                                            ...
                                            <th style="border: 1px solid #d0e0ed; padding: 12px 15px; text-align: right;">Số buổi / Sessions</th>
                                            <th style="border: 1px solid #d0e0ed; padding: 12px 15px; text-align: right;">Giờ/buổi / Hr/Ses</th>
                                            <th style="border: 1px solid #d0e0ed; padding: 12px 15px; text-align: right;">Tổng giờ / T.Hours</th>
                                    ...
                                    <tfoot style="font-weight: 600; background-color: #eaf3ff; border-top: 2px solid #007bff;">
                                        <tr>
                                            <td colspan="6" style="border: 1px solid #e0e0e0; padding: 12px 15px; text-align: right;"><strong>Tổng thu nhập / Total Gross Earnings:</strong></td>
